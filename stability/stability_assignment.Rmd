...
thresh <- seq(from = 10, to = 150, by = 1)
...
h_wrapper <- function(t, pop, pars, func, thresh) {
    pars <- list(rprey=0.95, alpha=0.01, eff=0.6,pmort=0.4, K=2000, harvest = 0.10, thresh = thresh)
...
allresults <- as.data.frame(thresh) %>% 
  pmap(h_wrapper, pop = pop, t = times, pars = pars, func = lotvmodK, thresh = .x)
